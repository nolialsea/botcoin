...
class TemporalAction{
	...
	*/
	...
	static init(){
		db.run("CREATE TABLE IF NOT EXISTS TemporalAction (typeActionId INTEGER NOT NULL, message TEXT, startDate INTEGER NOT NULL, duration INTEGER NOT NULL");
	}

	static save(temporalAction, callback){
		//Only inserts
		if (temporalAction.id !== null){
